...
$mail->Username = 'patelsanketh98@gmail.com'; // SMTP username
$mail->Password = 'sanketh143'; // SMTP password
$mail->SMTPSecure = 'tls'; // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587; // TCP port to connect to

$mail->setFrom('patelsanketh98@gmail.com', 'Integration System');
$mail->addReplyTo('patelsanketh98@gmail.com', 'Integration System');
...
$bodyContent .= '<p>Your Policy Number is ' . $policy_no . '.<br> and  your Claim ID is ' . $c_id . '<br>
 <strong style="color: #00b048">Your policy claim successfully, Our Insurance company contact you as soon as posible.</strong></p>';
...
$client->send('8758855301', 'Your Policy Number is ' . $policy_no . 'and  your Claim ID is ' . $c_id . ', Your policy claim successfully, Our Insurance company contact you as soon as posible.');
